...
async function smartScrollingExample(): Promise<void> {
  ...
  try {
    ...
    console.log(
      "• Large scrolls (80-90): Cover ~90% of viewport - great for content discovery",
    );
    console.log(
      "• Small scrolls (5-15): Cover ~5-15% of viewport - perfect for precise navigation",
    );
    console.log(
      "• Smart default: 90% viewport coverage when no amount specified",
    );
    console.log("• 10% overlap maintained for context in large scrolls");

    console.log("\n💡 Usage Guidelines:");
    console.log(
      "• Use scroll_amount 80-90 for: Page scanning, content discovery, long articles",
    );
    console.log(
      "• Use scroll_amount 5-15 for: Dropdowns, small lists, fine positioning",
    );
    console.log(
      "• Use scroll_amount 21-79 for: Standard navigation between these extremes",
    );
  } catch (error) {
