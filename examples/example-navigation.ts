...
async function navigationExample(): Promise<void> {
  ...
  try {
    ...
    await agent.execute('Navigate to https://github.com/anthropics/anthropic-sdk-typescript');
    
    // Extract information from the page
    const repoInfo = await agent.execute('What repository am I looking at and what is it for?');
    ...
    console.log('\nPerforming a search...');
    await agent.execute('Go to google.com and search for "playwright automation"');
