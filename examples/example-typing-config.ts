...
async function typingConfigExample(): Promise<void> {
  ...
  try {
    ...
    console.log('Agent will fill text instantly using locator.fill() (fill mode)');
    ...
    console.log('• Fill mode: Fastest overall typing (directly fills input fields)');
    ...
    console.log('• Use character-by-character for debugging/demos or human-like interaction');
