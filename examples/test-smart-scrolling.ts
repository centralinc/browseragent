...
async function testSmartScrolling(): Promise<void> {
  ...
  try {
    ...
    console.log(
      "🚀 Testing large scroll (85) to navigate between page sections...",
    );
    ...
    console.log(
      "🚀 Testing another large scroll (90) to continue navigation...",
    );
    ...
    console.log(
      "🔍 Testing smart scroll to text within the state picker dropdown...",
    );
    ...
    console.log(
      "🎯 Testing complete workflow: large scrolls + smart text scrolling...",
    );
    ...
    console.log("================");
    console.log(
      "✓ Large scrolls (80-90): Should efficiently navigate between page sections",
    );
    console.log(
      "✓ Playwright scroll_to_text: Should instantly find text in UI elements",
    );
    console.log(
      "✓ Default scroll: Should use 90% viewport for efficient navigation",
    );
    ...
    console.log(
      "• Playwright scroll_to_text instantly navigates to specific text",
    );
    console.log(
      "• LLM prioritizes playwright for finding text, falls back to regular scrolls",
    );
    console.log("• Zero wasted scroll attempts when finding specific options");

    console.log("\n🎯 Manual Verification:");
    console.log(
      "• Check that large scrolls move efficiently between colored sections",
    );
    console.log(
      "• Check that small scrolls work precisely within the state dropdown",
    );
    console.log(
      "• Check that small scrolls work precisely within the product list",
    );
    console.log(
      "• Verify no UI elements become unreachable due to scroll changes",
    );
  } catch (error) {
