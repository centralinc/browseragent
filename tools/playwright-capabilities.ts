...
/**
 * Register a new Playwright capability (DEPRECATED)
 *
 * @deprecated Use ComputerUseAgent constructor with playwrightCapabilities instead.
 * This function affects all agents globally and should not be used in production.
 */
export function registerPlaywrightCapability(capability: PlaywrightCapabilityDef): void {
  console.warn('⚠️  registerPlaywrightCapability is deprecated. Use ComputerUseAgent constructor with playwrightCapabilities instead.');
